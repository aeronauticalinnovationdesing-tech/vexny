...
export default function PilotManagementEnterprise() {
  ...
  // Get pilots for this company only
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => { queryClient.invalidateQueries({ queryKey: ["pilots-enterprise"] }); closeForm(); },
  });
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => queryClient.invalidateQueries({ queryKey: ["pilots-enterprise"] }),
  });
  ...
  const openEdit = (pilot) => {
    ...
    setForm({ ...emptyForm, ...pilot, habilitaciones: pilot.habilitaciones || [], company_id: company?.id });
    setShowForm(true);
  };
  ...
  const handleSave = (e) => {
    ...
    const data = { 
      ...
      hours_flown: Number(form.hours_flown) || 0, 
      hours_bvlos: Number(form.hours_bvlos) || 0, 
      hours_nocturno: Number(form.hours_nocturno) || 0 
    };
    ...
    <div className="p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
      ...
      <div className="space-y-3">
        {pilots.length === 0 && (
          <div className="text-center py-20 bg-card border border-dashed border-border rounded-2xl">
            <Users className="w-12 h-12 text-muted-foreground mx-auto mb-4" />
            <p className="text-muted-foreground">No hay pilotos registrados en tu empresa</p>
          </div>
        )}
          ...
          <form onSubmit={handleSave} className="space-y-5">
            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="text-sm font-medium">Fase en Proceso</label>
            ...
            <section>
              <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-3 pb-1 border-b">Rol y Estado</h3>
              <div className="grid grid-cols-2 gap-3">
                <div>
